...
seasonal_match_time <- tibble::tribble(
  ~round, ~start_time,
  1, as_datetime(paste0(Sys.Date(), " 10:55:00")),
  2, as_datetime(paste0(Sys.Date(), " 12:00:00")),
  3, as_datetime(paste0(Sys.Date(), " 13:05:00")),
  4, as_datetime(paste0(Sys.Date(), " 14:10:00")),
  5, as_datetime(paste0(Sys.Date(), " 15:15:00"))
)
