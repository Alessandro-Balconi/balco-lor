...
m_db1$remove(sprintf('{"info.game_start_time_utc": { "$lt" : "%sT00:00:00.000Z" }}', Sys.Date() - lubridate::days(30)))
m_db2$remove(sprintf('{"info.game_start_time_utc": { "$lt" : "%sT00:00:00.000Z" }}', Sys.Date() - lubridate::days(30)))
m_db3$remove(sprintf('{"info.game_start_time_utc": { "$lt" : "%sT00:00:00.000Z" }}', Sys.Date() - lubridate::days(30)))
