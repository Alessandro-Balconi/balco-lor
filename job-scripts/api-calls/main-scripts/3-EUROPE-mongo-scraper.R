  ...
  if(i == 1){
    ...
    if(get_leaderboard$status_code == 200){
      ...
      if(length(master_players) >= 50){
        ...
        saveRDS(object = puuid_list, file = "/home/balco/dev/lor-meta-report/templates/master_leaderboards/europe.rds")
        ...
        saveRDS(object = puuid_list, file = "/home/balco/dev/lor-meta-report/templates/master_leaderboards/old_europe.rds")
        
      } else if(file.exists("/home/balco/dev/lor-meta-report/templates/master_leaderboards/old_europe.rds")){
