...
# connect to MongoDB
m_db <- mongo(url = "mongodb://balco:n0nLadimentico@localhost:27017/admin", collection = "lor_match_info") # db with match to prepare
...
#DBI::dbWriteTable(conn = con, name = "lor_match_info", value = data, row.names = FALSE)
